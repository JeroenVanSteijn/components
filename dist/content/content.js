...
export var getEmployee = function (name) { return (employees.find(function (employee) { return employee.id === name; })); };
export var getEmployees = function (names) {
    var employeeList = [];
...
export var MeetTheFoundersData = [
    {
        company: "YoungPWR",
...
export var FrequentlyAskedQuestionsContent = [
    {
