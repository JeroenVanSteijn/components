    ...
    var Opened = function () {
        return (React.createElement(MobileMenuContainer, null,
            ...
            React.createElement(ContactContainer, null,
                React.createElement(ContactBox, { icon: "email", text: "Send us an email" }),
                React.createElement(ContactBox, { icon: "email", text: "Plan a meeting" }))));
    };
    return (React.createElement(React.Fragment, null,
        React.createElement(MobileMenuBarTopContainer, { background: isOpen ? theme.colors.white : undefined },
